...
class ViewController: UIViewController {
  ...
  func start() {
    ...
    let replaceableStrings = ["amazing", "beautiful", "different", "an experience."].map { text -> NSAttributedString in
    ...
    label.animationWithFixedString(fixedString, replaceableStrings: replaceableStrings, typeSpeed: 0.1, delay: 2) {
